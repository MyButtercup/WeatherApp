...
namespace WeatherApp.Views
{
    ...
    public partial class CurrentWeatherPage : ContentPage
    {
        ...
        private async void GetBackground()
        {
            ...
            var result = await ApiCaller.Get(url, "563492ad6f917000010000017abce26159ff4f1e83b9709538b31fcf");
        ...
        {
            var url = $"http://api.openweathermap.org/data/2.5/forecast?q={Location}&appid=ec8373111e548e416ee4ab0b3b2fbf91&units=metric";
            var result = await ApiCaller.Get(url);
            ...
            if (result.Successful)
            {
                try
                {
                    ...
                    {
                        //var date = DateTime.ParseExact(list.dt_txt, "yyyy-MM-dd hh:mm:ss", CultureInfo);
